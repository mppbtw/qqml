...
int get_cursor_cols() { return get_cursor_position().cols; }

int get_cursor_lines() { return get_cursor_position().lines; }
...
int clear_screen_with_width() { return clear_screen_with_termsize().width; }

int clear_screen_with_height() { return clear_screen_with_termsize().height; }
...
int break_cursor_with_width() { return break_cursor_with_termsize().width; }

int break_cursor_with_height() { return break_cursor_with_termsize().height; }
